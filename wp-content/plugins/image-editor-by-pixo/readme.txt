...
Contributors: ickata
Tags: image editor, photo editor, replace image, image optimization, image compression, batch image editing, batch photo editing, image filters, photo filters, paint, draw, tinypng
...
Integrates Pixo Image Editor – replaces the default editor for images in WordPress with more powerful one, and also can be integrated into the website front-end. The Image Editor supports:
   - bulk photo editing;
   - image overriding or save as new;
   - updates all image references in all post types and pages.
