...
class Form extends Model
{
    ...
    public function getFormInfo($formId)
    {
        ...
        if (!$form || $form->post_type != 'wp_payform') {
            throw new \Exception(__('Form not found', 'wp-payment-form'));
        }
    ...
    public static function storeData($request)
    {
        ...
        if (is_wp_error($formId)) {
            throw new Exception($formId->get_error_message());
        }
    ...
    public function updateForm($formId, $request_data)
    {
        ...
        if (!$formId || !$title) {
            throw new Exception(__('Please provide form title', 'wp-payment-form'));
        }
    ...
    public static function getReceiptSettings($formId)
    {
        ...
        $defaultSettings = array(
            'receipt_header' => __('Thanks for your submission. Here are the details of your submission:', 'wp-payment-form'),
            'receipt_footer' => '',
            'info_modules'   => [
                'input_details' => 'yes',
                'payment_info'  => 'yes'
