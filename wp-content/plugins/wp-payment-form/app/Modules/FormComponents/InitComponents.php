...
class InitComponents
{
    public function __init()
    {
        ...
        if (!defined('WPPAYFORMHASPRO')) {
            new \WPPayForm\App\Modules\FormComponents\DemoGateways();
            new \WPPayForm\App\Modules\FormComponents\DemoProducts();
            new \WPPayForm\App\Modules\FormComponents\DemoGeneralComponent();
        }
    }
}
