...
<div class="payform_admin wpf_content_wrapper_parent_v2">
    ...
    <div class="wpf_content_wrapper_v2">
        <?php do_action('wppayform_before_global_settings_wrapper'); ?>
        <div class="wppayform_sidebar_v2">
            <ul class="wppayform_sidebar_list_v2" style="margin-top: 0px;">
                ...
                <?php foreach ($components as $componentName => $component) : ?>
                    <li class="<?php echo esc_attr(Helper::getHtmlElementClass($component['hash'], $currentComponent)); ?> wppayform_item_<?php echo esc_attr($componentName); ?>">
                        <a data-settings_key="<?php echo Arr::get($component, 'settings_key'); ?>" data-component="<?php echo Arr::get($component, 'component', ''); ?>" data-hash="<?php echo Arr::get($component, 'hash', ''); ?>" href="<?php echo esc_url(Helper::makeMenuUrl('wppayform_settings', $component)); ?>">
                            <?php
                           ...
                           <p><?php echo __($component['title']) ?></p>
                        </a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
        <div class="wppayform_main_content_v2">
            <?php
