...
class AdminMenuHandler
{
    ...
    // {
    //     if ($menuPermission === 'wpf_can_view_menus' && ($userRole == 'paymattic_donor' || $userRole == 'paymattic_user' || $userRole == 'paymattic_subscriber')) {
    ...
    public function adminBarItem()
    {
        ...
        if (AccessControl::isPaymatticUser()) {
            $hasDashboardAccess = AccessControl::checkUserPermission('access_dashboard');
            $admin_url = $hasDashboardAccess
                ? admin_url('admin.php?page=wppayform.php#/paymattic-dashboard')
                : site_url();
